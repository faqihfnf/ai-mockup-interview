      ...
      <div className="mt-5 p-5 border rounded-lg">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
          {mockInterviewQuestions &&
            mockInterviewQuestions.map((question, index) => (
              <h2
                className={`p-2 border border-primary text-primary rounded-full text-sm md:text-md text-center cursor-pointer font-semibold ${
        ...
        <div className="border rounded-lg p-5 mt-10 bg-blue-100">
          ...
          <h2 className="text-lg text-primary my-3">
            ...
            a score for your answer. Make sure you answer the question with a
            clear voice!
          </h2>
        </div>
      </div>
