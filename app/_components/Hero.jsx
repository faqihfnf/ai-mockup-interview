...
function Hero() {
  ...
  return (
    <section className="relative text-black bg-white-50 ">
      ...
      <div className="">
        {/* Purple gradient */}
        <div className="absolute -z-50 top-0 left-0 w-full blur-[110px] h-1/3 bg-gradient-to-br from-violet-500 via-transparent to-pink-400 "></div>
        {/* Blue gradient */}
        <div className="absolute -z-50 top-0 right-0 w-[60%] blur-[110px] h-1/6 bg-gradient-to-bl from-cyan-500 via-sky-300 to-green-500"></div>
      </div>
      <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center mt-4">
        <div className="mx-auto text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <a
              className="flex gap-4 justify-center items-center w-full rounded-md border bg-purple-50 border-purple-600 hover:border-purple-800 px-6 py-3 text-lg font-semibold text-purple-600 hover:bg-gradient-to-bl hover:from-purple-100 hover:via-violet-100 hover:to-indigo-100 focus:outline-none focus:ring active:bg-purple-200 sm:w-auto"
